void initAnimation() {
  ...
  seq.add(Ani.to(this, 1.8, "eyeY", 850, Ani.SINE_IN_OUT));
  ...
  seq2.beginSequence();
  seq2.add(Ani.to(this, 0.00002, "eye", 255, Ani.QUAD_OUT));
  ...
  seq2.add(Ani.to(this, 0.6, "bluck_x", bluck_x+60, Ani.QUINT_OUT));
  seq2.add(Ani.to(this, 0.6, "circleX1", circleX1+60, Ani.QUINT_OUT));
  seq2.endStep();
  seq2.beginStep();
  seq2.add(Ani.to(this, 0.3, "red_y", height/2+71, Ani.LINEAR));
  seq2.endStep();
  seq2.beginStep();
  seq2.add(Ani.to(this, 2.2, "red_y", red_y+200, Ani.QUAD_OUT));
  seq2.add(Ani.to(this, 2.2, "bluck_y", bluck_y+200, Ani.QUAD_OUT));
  seq2.add(Ani.to(this, 2.2, "circleY1", circleY1+200, Ani.QUAD_OUT, "onStart:effect2"));
  seq2.add(Ani.to(this, 2.2, "eyeY", eyeY+200, Ani.QUAD_OUT));
  seq2.add(Ani.to(this, 2.2, "eye", 100, Ani.QUAD_OUT));
  seq2.endStep();
  seq2.beginStep();
  seq2.add(Ani.to(this, 0.2, "red_y", red_y+200, Ani.QUAD_OUT));
  seq2.add(Ani.to(this, 0.2, "bluck_y", bluck_y+200, Ani.QUAD_OUT));
  seq2.add(Ani.to(this, 0.2, "circleY1", circleY1+200, Ani.QUAD_OUT));
  seq2.add(Ani.to(this, 0.2, "eyeY", eyeY+200, Ani.QUAD_OUT));
  seq2.add(Ani.to(this, 0.2, "eye", 0, Ani.QUAD_OUT));
  seq2.endStep();
  seq2.beginStep();
  seq2.add(Ani.to(this, 2, "starY", 300, Ani.QUAD_OUT));
  seq2.add(Ani.to(this, 2, "starRotation", 10, Ani.QUAD_OUT));
  seq2.endStep();
  seq2.beginStep();
  seq2.add(Ani.to(this, 1, "starY", 600, Ani.SINE_IN));
  seq2.add(Ani.to(this, 1, "starX", 300, Ani.LINEAR));
  seq2.add(Ani.to(this, 1, "starRotation", 6, Ani.QUAD_OUT));
  seq2.endStep();
  seq2.beginStep();
  seq2.add(Ani.to(this, 1, "starY", 800, Ani.SINE_IN));
  seq2.add(Ani.to(this, 1, "starX", 1300, Ani.LINEAR));
  seq2.add(Ani.to(this, 1, "starRotation", 12, Ani.QUAD_OUT));
  seq2.endStep();
  seq2.beginStep();
  seq2.add(Ani.to(this, 0.1, "starY", -800, Ani.LINEAR));
  seq2.add(Ani.to(this, 0.1, "starX", -100, Ani.LINEAR));
